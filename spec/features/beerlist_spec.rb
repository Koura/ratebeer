...
describe "Beerlist page" do
  ...
  it "should have beers listed according to alphabetic order", js: true do
    visit beerlist_path
  ...
  it "should list beers according to style when clicked", js: true do
    visit beerlist_path
    click_link('Style')
  ...
  it "should list beers according to breweries when clicked", js: true do
    visit beerlist_path
    click_link('Brewery')
